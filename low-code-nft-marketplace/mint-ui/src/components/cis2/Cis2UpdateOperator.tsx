...
function Cis2UpdateOperator(props: {
  ...
  function update() {
    ...
    const {
      ...
      parameter: { json },
      schema,
    } = props.cis2Contract.createUpdateOperator(
      { energy: BigInt(6000) },
      {
    ...
    props.provider
      .sendTransaction(props.account, type, payload, json, schema as SchemaWithContext)
  ...
  return (
    <>
      ...
      <Button variant="contained" disabled={state.updating} onClick={() => update()}>
