import { AccountAddress, AccountTransaction, AccountTransactionHeader, AccountTransactionType, CcdAmount, NextAccountNonce, TransactionExpiry } from "@concordium/web-sdk";
import { ConcordiumGRPCNodeClient } from "@concordium/web-sdk/nodejs";

export default async function createAccountTransaction(client: ConcordiumGRPCNodeClient, sender: string, receiver: string): Promise<AccountTransaction> {
