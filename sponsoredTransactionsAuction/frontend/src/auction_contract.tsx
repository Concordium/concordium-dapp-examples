...
export async function addItem(
    ...
    if (!dryRunResult || dryRunResult.tag === 'failure' || !dryRunResult.returnValue) {
        // The `parseErrorMessageBid` (as generated by the `ccd-js-gen` package) parses all error messages that exist in the smart contract currently (not only the once in the bid function).
        // As a result, the `parseErrorMessageBid` can be used to parse the error messages here.
        const parsedErrorCode = AuctionContract.parseErrorMessageBid(dryRunResult)?.type;
