...
export async function mint(
    ...
    if (!dryRunResult || dryRunResult.tag === 'failure' || !dryRunResult.returnValue) {
        // The `parseErrorMessageMint` (as generated by the `ccd-js-gen` package) parses all error messages that exist in the smart contract currently (not only the once in the mint function).
        // As a result, the `parseErrorMessageMint` can be used to parse the error messages here.
