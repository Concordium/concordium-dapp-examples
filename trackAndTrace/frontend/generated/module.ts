...
/** Client for an on-chain smart contract module with module reference 'deb674cbaf7ae78fafac2d07414a3da6e437ee075a9a4be9937eb5f729602eb7', can be used for instantiating new smart contract instances. */
class ModuleModule {
 ...
 * Construct a ModuleModule client for interacting with a smart contract module on chain.
 * This function ensures the smart contract module is deployed on chain.
 * @param {ModuleModule} moduleClient - The client of the on-chain smart contract module with referecence 'deb674cbaf7ae78fafac2d07414a3da6e437ee075a9a4be9937eb5f729602eb7'.
 * @throws If failing to communicate with the concordium node or if the module reference is not present on chain.
 * @returns {ModuleModule} A module client ensured to be deployed on chain.
 */
