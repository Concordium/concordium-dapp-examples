...
export function runServer(appConfig: AppConfig) {
    ...
    app.use(cors({
        origin: ['http://localhost:5173', 'http://localhost:3000', 'https://allowlist.devnet-plt-beta.concordium.com', 'https://allowlist.testnet.concordium.com'], // AllowListManager Frontend
        methods: ['GET', 'POST'],
    }));
