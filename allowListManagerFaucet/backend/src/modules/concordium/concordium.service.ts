...
import { AccountAddress, parseWallet, buildAccountSigner, AccountSigner, TransactionHash } from '@concordium/web-sdk';
...
export class ConcordiumService implements OnModuleInit {
    ...
    async waitForTransactionFinalization(txHash: TransactionHash.Type, timeoutMs: number = 30000): Promise<any> {
