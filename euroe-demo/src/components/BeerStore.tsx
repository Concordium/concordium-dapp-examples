            ...
            <Dialog open={open} onClose={handleClose}>
                ...
                <List>
                    <ListItem>
                        ...
                        <ListItemText
                            primary={`Buy ${selectedItems.length} ${
                                selectedItems.length === 1 ? 'beer' : 'beers'
                            } for ${selectedItems.length} EUROe`}
                        />
                    </ListItem>
                </List>
                <DialogActions>
        ...
        <Box>
            ...
            <FormControl sx={{ m: 3 }} component="fieldset" variant="standard" style={{ textAlign: 'center' }}>
                <FormLabel component="legend">
                    Select which beers to buy. You must select at least one to proceed.
                </FormLabel>
                <FormGroup aria-label="position" row>
                    ...
                    {state.map((item, index) => (
                        <FormControlLabel
                            control={
                                <Checkbox checked={item.selected} onChange={handleChange(index)} name={item.name} />
                            }
                            label={item.name}
