            ...
            <div className="main">
                {!isVerified && (
                    <div className="verify-page">
                        <h4 className="verify-title">Click to verify your age</h4>
                        <Typography variant="h4" component="div" sx={{ flexGrow: 1, mt: 1 }}></Typography>
                        <button color="inherit" onClick={ageCheck} className="button green-text">
                            VERIFY
                        </button>
                        <a className="read-more green-text" href="https://www.concordium.com">
                            Read more
                        </a>
                    </div>
                )}
                {isVerified && (
                    <div className="beer-page white">
                        ...
                        <a className="read-more" href="https://www.concordium.com">
                            Read more!
                        </a>
                    </div>
                )}
